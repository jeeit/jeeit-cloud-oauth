...
package com.jeeit.oauth.component;

import com.jeeit.oauth.exception.*;
...
public class WebResponseExceptionTranslator implements org.springframework.security.oauth2.provider.error.WebResponseExceptionTranslator {
	...
	private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) throws IOException {
		...
		ResponseEntity<OAuth2Exception> response = new ResponseEntity<>(new OauthAuth2Exception(e.getMessage()), headers,

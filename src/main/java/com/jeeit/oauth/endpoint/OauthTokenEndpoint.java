...
package com.jeeit.oauth.endpoint;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.plugins.Page;
import com.jeeit.oauth.common.SecurityConstants;
import com.jeeit.oauth.service.OauthUser;
	...
	public Page tokenList(@RequestBody Map<String, Object> params, @RequestHeader(required = false) String from) {
		...
		for (String page : pages) {
			...
			if (authentication instanceof UsernamePasswordAuthenticationToken) {
				...
				if (authenticationToken.getPrincipal() instanceof OauthUser) {
					OauthUser user = (OauthUser) authenticationToken.getPrincipal();
